...
public class Listener extends TestListenerAdapter {
    ...
    public void onStart(ITestContext testContext) {
        ...
        htmlReporter = new ExtentHtmlReporter( "D:\\OCIAutomation\\test-output\\"+repName); //report file location
        htmlReporter.loadConfig("D:\\OCIAutomation\\src\\test\\resources\\extent-config.xml");
