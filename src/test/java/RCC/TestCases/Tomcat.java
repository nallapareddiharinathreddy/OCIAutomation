...
public class Tomcat extends TestBase {
    ...
    public void tomcatStop() {
        try {
            loggerextent= ExtentReport.extent.createTest("Tomcat Operations Stop ");
            ...
            tomcat.next_button.click();
            tomcat.need_thread_dump_no.click();
    ...
    {
        try {
            loggerextent=ExtentReport.extent.createTest("Tomcat Operations Start");
            loggerextent.assignCategory("SmokeTesting");
            loggerextent.assignAuthor("Harinathreddy");
    ...
    public void tomcatreStart()
    {
        try
        {
            loggerextent=ExtentReport.extent.createTest("Tomcat Operations Restart");
            loggerextent.assignCategory("SmokeTesting");
            loggerextent.assignAuthor("Harinathreddy");
...
tomcat.need_thread_dump_no.click();
    ...
    public void tomcatDumpThreads() {
        try
        {
            loggerextent=ExtentReport.extent.createTest("Tomcat Operations  DumpThreads ");
            loggerextent.assignCategory("SmokeTesting");
            loggerextent.assignAuthor("Harinathreddy");
    ...
    public void tomcatHardStop()
    {
        try
        {
            loggerextent=ExtentReport.extent.createTest("Tomcat Operations HardStop");
            loggerextent.assignCategory("SmokeTesting");
            loggerextent.assignAuthor("Harinathreddy");
